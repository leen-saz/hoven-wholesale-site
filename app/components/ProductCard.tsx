  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        {/* Animation on left (desktop), top (mobile) */}
        <div className={isArabic ? 'lg:order-2' : 'lg:order-1'}>
          <ScrollLinkedAnimation
            frameDir={`/frames/${video}/`}
            frameCount={frameCount}
            elementId={`product-${id}`}
          />
        </div>

        {/* Product info on right (desktop), bottom (mobile) */}
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 py-4 border-y border-gray-200">
              <div>
                ...
                <p className="text-2xl font-semibold text-gray-900">{heightCm} cm</p>
              </div>
              <div>
                <p className="text-sm text-gray-500 mb-1">
