      ...
      <section id="top" className="relative h-screen flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-6 max-w-3xl mx-auto">
            {lang === "ar" ? "المفروشات الفندقية" : "Hotel Linens"}
          </h1>
          <p className="text-lg mb-8 max-w-2xl mx-auto opacity-90">
            {lang === "ar"
              ? "مفروشات فندقية من أفضل جودة توفر الراحة واللمعان الفاخر لليلة نوم مثالية."
              : "Premium hotel linens offering comfort and luxury finish for the perfect night's rest."}
          </p>
        </div>
      </section>
